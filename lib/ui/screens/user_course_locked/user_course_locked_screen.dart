...
class UserCourseLockedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context) => _bloc, child: UserCourseLockedWidget(args.courseId));
  }
}
...
class UserCourseLockedWidgetState extends State<UserCourseLockedWidget> {
  ...
  void initState() {
    super.initState();
    _bloc = BlocProvider.of<CourseBloc>(context)..add(FetchEvent(widget.courseId));
                              ...
                              children: <Widget>[
                                GestureDetector(
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    (state is LoadedCourseState) ? state.courseDetailResponse.author?.avatar_url : "",
                                  )),
                                )
                              ],
                            ),
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: SizedBox(width: 48, height: 61, child: SvgPicture.asset('assets/icons/lock.svg')),
            ),
            Padding(

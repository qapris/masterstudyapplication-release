...
class _DetailProfileWidgetState extends State<DetailProfileWidget> {
  ...
  bool get _isAppBarExpanded {
    return _scrollController.hasClients && _scrollController.offset > (MediaQuery.of(context).size.height / kef - kToolbarHeight);
  }
                                ...
                                child: Container(
                                  child: Center(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Padding(padding: const EdgeInsets.only(top: 30.0), child: avatar),
                                        Padding(
                                                ...
                                                if (_bloc.account!.meta!.instagram != "")
                                                  Padding(
                                                    ...
                                                    child: GestureDetector(
                                                      ...
                                                      child: SizedBox(width: 20, height: 20, child: SvgPicture.asset("assets/icons/ico_insta.svg", color: Colors.white)),
                                                    ),
                                                  ),
                                              ],
                                            ),

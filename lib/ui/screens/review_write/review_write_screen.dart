...
class ReviewWriteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<ReviewWriteBloc>(create: (c) => _bloc, child: _ReviewWriteScreenWidget(args.courseId, args.courseTitle));
  }
}
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(widget.courseTitle, textScaleFactor: 1.0, textAlign: TextAlign.center, style: TextStyle(fontSize: 20.0, color: Colors.black, fontWeight: FontWeight.w600)),
                            ),
                            Padding(
                                padding: EdgeInsets.only(top: 20.0, bottom: 20.0),
                                child: TextFormField(

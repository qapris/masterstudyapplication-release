...
class FinalScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<FinalBloc>(create: (c) => _bloc, child: _FinalScreenWidget(args.course_id));
  }
}
...
class _FinalScreenState extends State<_FinalScreenWidget> {
  ...
  _buildBody(FinalState state) {
        ...
        children: <Widget>[
          Padding(
              ...
              child: Text(
                ...
                style: TextStyle(fontSize: 15.0, color: HexColor.fromHex("#2A3045")),
              )),
          Padding(
              ...
              child: Text(
                ...
                textScaleFactor: 1.0,
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 15.0, fontWeight: FontWeight.w700, color: HexColor.fromHex("#2A3045")),
              )),
          Padding(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(border: Border.all(color: HexColor.fromHex("#EEF1F7"), width: 1), borderRadius: BorderRadius.circular(10.0)),
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  if (state.finalResponse.curriculum?.lesson != null)
                    _buildCard(state, "assets/icons/final_pages.svg", "#2476F5", "PAGES", "${state.finalResponse.curriculum?.lesson?.completed}/${state.finalResponse.curriculum?.lesson?.total}"),
                  if (state.finalResponse.curriculum?.multimedia != null)
                    _buildCard(
                        state, "assets/icons/final_video.svg", "#F61B40", "VIDEO", "${state.finalResponse.curriculum?.multimedia?.completed}/${state.finalResponse.curriculum?.multimedia?.total} hrs"),
                  if (state.finalResponse.curriculum?.assignment != null)
                    _buildCard(state, "assets/icons/assignnments_icon.svg", "#E9B356", "ASSIGNMENT",
                  ...
                  if (state.finalResponse.curriculum?.quiz != null)
                    _buildCard(state, "assets/icons/final_quizes.svg", "#13C79B", "QUIZES", "${state.finalResponse.curriculum?.quiz?.completed}/${state.finalResponse.curriculum?.quiz?.total}"),
                ],
              )),
          Padding(
    ...
    if (state is InitialFinalState) {
      return Center(
        child: Padding(padding: EdgeInsets.only(top: 20.0, bottom: 20.0), child: CircularProgressIndicator()),
      );
    }
  }
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text(title, textScaleFactor: 1.0, style: TextStyle(fontSize: 12.0, fontWeight: FontWeight.w500)),
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 3.0),
                        child: Text(value, textScaleFactor: 1.0, style: TextStyle(fontSize: 17.0, fontWeight: FontWeight.w500)),
                      ),
                    ],
                  ),
                ],
      ...
      return Row(
        ...
        children: <Widget>[
          Container(
            ...
            height: 74.0,
            decoration: BoxDecoration(color: HexColor.fromHex("#EEF1F7"), borderRadius: BorderRadius.circular(10.0)),
          )
        ],
      );
    }
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    percent.toString() + "%",
                    textScaleFactor: 1.0,
                    style: TextStyle(fontSize: 45.0, fontWeight: FontWeight.w700, color: HexColor.fromHex("#2A3045")),
                  ),
                )
              ],
            ),
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                ...
                textAlign: TextAlign.center,
                textScaleFactor: 1.0,
                style: TextStyle(color: HexColor.fromHex("#AAAAAA"), fontSize: 14.0),
              ),
            ),
            SizedBox(
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushNamed(
                          ...
                          arguments: ReviewWriteScreenArgs(state.finalResponse.course!.course_id!, state.finalResponse.title!),
                        );
                      },
                      child: Text(
                        "LEAVE REVIEW",

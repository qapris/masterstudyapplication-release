...
import 'package:masterstudy_app/ui/screens/assignment/assignment_parts/assignment_info.dart';
...
class AssignmentPassUnpassWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AssignmentPassUnpassWidgetState();
}
    ...
    return Column(
      ...
      children: <Widget>[
        Padding(
            ...
            child: Container(
              decoration: BoxDecoration(color: HexColor.fromHex("#EEF1F7"), borderRadius: BorderRadius.circular(8.0)),
              child: Padding(
                    ...
                    children: <Widget>[
                      Container(
                        child: ClipRRect(
                          ...
                          child: Container(
                            decoration: BoxDecoration(color: (widget.assignmentResponse.status == 'passed') ? secondColor : HexColor.fromHex("#F44336")),
                            child: Padding(
                      ...
                      Expanded(
                        child: Text(
                          ...
                          textScaleFactor: 1.0,
                          style: TextStyle(color: HexColor.fromHex("#273044"), fontSize: 18.0, fontWeight: FontWeight.w700),
                        ),
                      )
                    ],
                  )),
        ...
        (widget.assignmentResponse.status == 'unpassed')
            ? Padding(
                ...
                child: MaterialButton(
                  ...
                  child: Text("Retake Assignment", textScaleFactor: 1.0, style: TextStyle(color: Colors.white)),
                ))
            : Center(),

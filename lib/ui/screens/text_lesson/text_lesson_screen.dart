...
class TextLessonScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<TextLessonBloc>(create: (context) => bloc, child: TextLessonWidget(args.courseId, args.lessonId, args.authorAva, args.authorName, args.hasPreview, args.trial));
  }
}
...
class TextLessonWidget extends StatefulWidget {
  ...
  const TextLessonWidget(this.courseId, this.lessonId, this.authorAva, this.authorName, this.hasPreview, this.trial) : super();

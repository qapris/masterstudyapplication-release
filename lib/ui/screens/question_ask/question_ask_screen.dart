                ...
                child: Padding(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                      Padding(
                          ...
                          child: Text(localizations.getLocalization("ask_your_question"),
                              textScaleFactor: 1.0, style: TextStyle(color: HexColor.fromHex("#273044"), fontWeight: FontWeight.w700, fontSize: 18))),
                      Padding(
                        ...
                        child: new MaterialButton(
                          ...
                          onPressed: () {
                            if (textController.text != "") {
                              _bloc.add(QuestionAddEvent(widget.lessonId, textController.text));
                              setState(() {
                                sendRequest = true;
                              });
                            }

...
class HomeRepositoryImpl implements HomeRepository {
  ...
  Future<AppSettings> getAppSettings() async {
    ...
    if (appSettings.options?.main_color != null) {
      _sharedPreferences.setInt('main_color_r', appSettings.options?.main_color?.r.toInt());
      _sharedPreferences.setInt('main_color_g', appSettings.options?.main_color?.g.toInt());
      _sharedPreferences.setInt('main_color_b', appSettings.options?.main_color?.b.toInt());
    ...
    if (appSettings.options?.secondary_color != null) {
      _sharedPreferences.setInt('second_color_r', appSettings.options?.secondary_color?.r.toInt());
      _sharedPreferences.setInt('second_color_g', appSettings.options?.secondary_color?.g.toInt());

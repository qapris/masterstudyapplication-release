...
UserCourseResponse _$UserCourseResponseFromJson(Map<String, dynamic> json) {
  return UserCourseResponse(
    posts: (json['posts'] as List).map((e) => e == null ? null : PostsBean.fromJson(e as Map<String, dynamic>)).toList(),
...
PostsBean _$PostsBeanFromJson(Map<String, dynamic> json) {
  return PostsBean(
    ...
    post_status: json['post_status'] == null ? null : PostStatusBean.fromJson(json['post_status'] as Map<String, dynamic>),

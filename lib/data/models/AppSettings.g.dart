...
AppSettings _$AppSettingsFromJson(Map<String, dynamic> json) {
  return AppSettings(
    ...
    home_layout: (json['home_layout'] as List).map((e) => e == null ? null : HomeLayoutBean.fromJson(e as Map<String, dynamic>)).toList(),
...
OptionsBean _$OptionsBeanFromJson(Map<String, dynamic> json) {
  return OptionsBean(
    ...
    secondary_color: json['secondary_color'] == null ? null : ColorBean.fromJson(json['secondary_color'] as Map<String, dynamic>),

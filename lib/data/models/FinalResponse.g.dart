...
Map<String, dynamic> _$FinalResponseToJson(FinalResponse instance) => <String, dynamic>{
...
Map<String, dynamic> _$CourseBeanToJson(CourseBean instance) => <String, dynamic>{
...
CurriculumBean _$CurriculumBeanFromJson(Map<String, dynamic> json) {
  return CurriculumBean(
    multimedia: json['multimedia'] == null ? null : TypeBean.fromJson(json['multimedia'] as Map<String, dynamic>),
    lesson: json['lesson'] == null ? null : TypeBean.fromJson(json['lesson'] as Map<String, dynamic>),
    assignment: json['assignment'] == null ? null : TypeBean.fromJson(json['assignment'] as Map<String, dynamic>),
    quiz: json['quiz'] == null ? null : TypeBean.fromJson(json['quiz'] as Map<String, dynamic>),
  );
}

...
QuestionsResponse _$QuestionsResponseFromJson(Map<String, dynamic> json) {
  return QuestionsResponse(
    posts: (json['posts'] as List).map((e) => e == null ? null : QuestionBean.fromJson(e as Map<String, dynamic>)).toList(),
  );
}
...
QuestionBean _$QuestionBeanFromJson(Map<String, dynamic> json) {
  return QuestionBean(
    ...
    replies: (json['replies'] as List).map((e) => e == null ? null : ReplyBean.fromJson(e as Map<String, dynamic>)).toList(),
  );
}

...
CourseDetailResponse _$CourseDetailResponseFromJson(Map<String, dynamic> json) {
  return CourseDetailResponse(
    ...
    meta: (json['meta'] as List).map((e) => e == null ? null : MetaBean.fromJson(e as Map<String, dynamic>)).toList(),
    announcement: json['announcement'] as String,
    purchase_label: json['purchase_label'] as String,
    curriculum: (json['curriculum'] as List).map((e) => e == null ? null : CurriculumBean.fromJson(e as Map<String, dynamic>)).toList(),
    // faq: (json['faq'] as List).map((e) => e == null ? null : FaqBean.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$CourseDetailResponseToJson(CourseDetailResponse instance) => <String, dynamic>{
      'id': instance.id,
